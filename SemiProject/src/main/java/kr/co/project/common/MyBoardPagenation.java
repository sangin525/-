package kr.co.project.common;

public class MyBoardPagenation {
	
	public static MyBoardPageInfo getPageInfo(int myListCount,
									   int currentPage,
									   int pageLimit,
									   int boardLimit) {
		// 전체 페이지 구하기
		...
		int maxPage = (int)Math.ceil((double)myListCount/boardLimit);
...
//			boardLimit = offset+4;
//		}
		MyBoardPageInfo pi = new MyBoardPageInfo(myListCount, 
								   currentPage,
								   pageLimit,
								   boardLimit,
								   maxPage,
