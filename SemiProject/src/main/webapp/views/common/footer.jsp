  ...
  <footer class="Main_footer">
	...
	<div class="footerBox">
		<ul>
			...
			<li class="footer5">		<div id="google_translate_element" style="visibility: hidden; position: absolute; top: 0px;"></div>
<div class="translation-icons" style="visibility: hidden; position: relative; text-align: center; margin:0px; padding:0px; zoom:1"> 
	...
	<tr class="translation-links">
		<td><a href="javascript:void(0)" class="ko" data-lang="ko" data-placement="0" id="lang">한국어</a></td>
		<td><a href="javascript:void(0)" class="en" data-lang="en" data-placement="2" id="lang">영어</a></td>
		<td><a href="javascript:void(0)" class="ja" data-lang="ja" data-placement="3" id="lang">일본어</a></td>
		<td><a href="javascript:void(0)" class="cn" data-lang="zh-CN" data-placement="4" id="lang">중국어</a></td>
	</tr>
	</table>
		...
		<hr>
		<dl>㈜호텔하루 경기도 안양시 무슨구 무슨동 111-1 &nbsp;&nbsp; (우)11111 &nbsp;&nbsp; 
		Tel: 031-111-1111 &nbsp;&nbsp;Fax: 032-1111-1111</dl>
		<p>사업자등록번호: 111-11-11123 &nbsp;&nbsp;
		 대표이사: 여기어때&nbsp;&nbsp; 호스팅서비스제공자: 호텔하루 </p>
	</div>
  </footer>
