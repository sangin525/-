				...
				<div class="input-form col-md-12 mx-auto">
					...
					<form name="frm" action="Signup.do" method="POST" onsubmit="return sendChk()" >
						...
						<div class="row">
							...
							<div class="col-sm-10">
								...
								<div class="input-group mb-3">
  								...
  								<button class="left-btn" onclick="duplicateId()" id="M_IdCheckbtn" type="button">중복확인</button>
								</div>
						...
						<div class="mb-3">
							...
							<button class="left-btn" onclick="duplicateEmail()" id="M_EamilCheckbtn" type="button">중복확인</button>
							</div>
					...
					<div class="mb-3">
						...
						<div class="col-sm-10">
							<div class="input-group mb-1">
								...
								<input type="button" class="left-btn" onclick="sample6_execDaumPostcode()" value="우편번호 찾기">
							</div>
