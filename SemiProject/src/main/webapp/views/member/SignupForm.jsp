                        ...
                        <form name="frm" action="Signup.do" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="M_Name" name="M_Name"
                                    placeholder="이름" value="" onkeyup="validateName()">
                            ...
                            <div class="mb-3">
                                ...
                                <span id="idHelpInline" class="form-text"> 아이디는 5~10자 길이로
                                    문자와 숫자를 포함해야 하며 공백, 특수 문자 또는 이모티콘을 포함할 수 없습니다. </span>
                            ...
                            <div class="mb-3">
                                <label for="M_Pwdchek" class="form-label">비밀번호확인 *</label>
                                <input type="password" class="form-control" id="M_Pwdchek" name="M_Pwdchek"
                                    onkeyup="validatePassword()" maxlength="20"
                                    placeholder="비밀번호확인">
                                <span id="M_PwdchekMsg"></span>
                            </div>

                            <div class="mb-3">
                                <label for="M_Birth" class="form-label">생년월일 *</label>
                                <input type="date" class="form-control" id="M_Birth" name="M_Birth"
                                    onkeyup="validateBirth()" placeholder="(예:20031015)">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="sample6_address"
                                    name="M_Addr1" placeholder="주소">
                                <input type="text" class="form-control"
                                    id="sample6_detailAddress" name="M_Addr2" placeholder="상세주소">
                                <input type="text" class="form-control"
