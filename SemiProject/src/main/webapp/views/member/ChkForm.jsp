...
<head>
    ...
    <style>
        textarea {
            white-space: pre-line; /* 줄 바꿈과 여백 유지 */
            font-family: 'Courier New', monospace; /* 등 너비 글꼴 사용 */
        }
    </style>
</head>
            ...
            <form name="frm" action="SignupForm.do" method="Post">
                <div class="checkbox-container">
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="selectAllCheckbox">모두 선택</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input chkInp" id="termsCheckbox" name="termsCheckbox" value="y">
                        <label class="custom-control-label" for="termsCheckbox">이용 약관에 동의합니다. (필수)</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <!-- textarea 추가 -->
